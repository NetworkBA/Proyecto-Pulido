    ...
    <div class="app-body">
       ...
       <div class="sidebar">
            <nav class="sidebar-nav">
                <ul class="nav">
                    <li class="nav-item">
                        <a class="nav-link active" href="#"><i class="icon-speedometer"></i> Menu Principal</a>
                    </li>
                    <li class="nav-title">
                        Menú
                    </li>
       ...
       <main class="main">
            <!-- Breadcrumb -->
            <ol class="breadcrumb">
                <li class="breadcrumb-item active"><a href="">SISTEMA DE ESCOLAR</a></li>
            </ol>
...
<script>
    export default {
        mounted() {
            console.log('Component Menu montado.')
        }
    }
</script>
